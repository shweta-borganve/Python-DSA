...
def test_main_menu_all_options(mock_main_dependencies, monkeypatch, capsys):
    ...
    monkeypatch.setattr(
        "src.services.main.add_product",
        lambda: None,
    )

    monkeypatch.setattr(
        "src.services.main.view_products",
        lambda: None,
    )

    monkeypatch.setattr(
        "src.services.main.search_product",
        lambda: None,
    )

    monkeypatch.setattr(
        "src.services.main.update_product",
        lambda: None,
    )

    monkeypatch.setattr(
        "src.services.main.delete_product",
        lambda: None,
    )
    ...
    monkeypatch.setattr(
        "src.services.main.view_bill_history",
        lambda: None,
    )

    monkeypatch.setattr(
        "src.services.main.generate_sales_report",
        lambda: None,
    )

    monkeypatch.setattr(
        "src.services.main.check_and_display_low_stock",
        lambda: None,
    )
